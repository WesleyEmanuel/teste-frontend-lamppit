...
2. Implemente o que é proposto no [protótipo](https://github.com/juniorlampp/teste-frontend-lamppit/blob/main/material/prototipo.png). **! Importante !** A implementação dos gráficos é opcional para candidatos a vagas de nível trainee/estágio, junior e pleno ([
